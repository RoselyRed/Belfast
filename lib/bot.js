...
const api = process.env.SEARCH_SITE || "https://iambelfast.herokuapp.com/";
...
const startMessage = `
Hi there, I'm Belfast here to Manage your Magnet and Related Stuffs.
First of all, I'd like to let you know there are currently 3 sites available for searching: piratebay, 1337x and limetorrent.

Let's Move onto Commands.

/search {site} {query} - To search for torrents
query is what you want to search for
eg. 
    /search piratebay Love
    /search piratebay Love Live
    /search 1337x Darling in The
...
/server status - To get Detailed Info of the Server Status.
/server uptime - To get Uptime Detail of the Server.
/server diskinfo - To get Disk Info of the Server.

I'm in the service, So Be Happy!
`;
